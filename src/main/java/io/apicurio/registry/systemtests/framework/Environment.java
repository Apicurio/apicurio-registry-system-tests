...
public final class Environment {
    ...
    public static final String REGISTRY_CSV_DEFAULT = "service-registry-operator.v2.6.13-r2-0.1765811602.p";
    ...
    public static final String REGISTRY_OPERATOR_DEPLOYMENT_NAME_DEFAULT = "apicurio-registry-operator-v2.6.13-r2";
    public static final String REGISTRY_OPERATOR_DEPLOYMENT_NAME_UPGRADE_DEFAULT
            = "apicurio-registry-operator-v2.6.13-r2";
