...
public final class Environment {
    ...
    public static final String REGISTRY_CSV_DEFAULT = "service-registry-operator.v2.6.13-r3";
    ...
    public static final String REGISTRY_OPERATOR_DEPLOYMENT_NAME_DEFAULT = "apicurio-registry-operator-v2.6.13-r3";
