...
public class ArtifactGroupOwnerOnlyAuthorization {
    public static void testArtifactGroupOwnerOnlyAuthorization(ApicurioRegistry3 apicurioRegistry) {
        ...
        ApicurioRegistryUtils.createOrReplaceEnvVar(apicurioRegistry, new Env() {{
            setName("APICURIO_AUTH_OWNER-ONLY-AUTHORIZATION_LIMIT-GROUP-ACCESS");
            setValue("true");
        }});
        // Wait for API availability
        Assertions.assertTrue(ownerClient.waitServiceAvailable());
